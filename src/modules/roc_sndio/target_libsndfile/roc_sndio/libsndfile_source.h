...
//! @file roc_sndio/target_libsndfile/roc_sndio/libsndfile_source.h
//! @brief sndfile source.

#ifndef ROC_SNDIO_LIBSNDFILE_SOURCE_H_
#define ROC_SNDIO_LIBSNDFILE_SOURCE_H_
...
class SndFile : public ISource, private core::NonCopyable<> {
public:
    //! Initialize.
    SndFile(core::IAllocator& allocator, const Config& config);
